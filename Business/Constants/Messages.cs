...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string ListedBrand = "Markalar başarıyla listelendi.";
        ...
        public static string ListedCar = "Arabalar başarıyla listelendi.";
        ...
        public static string ListedColor = "Renkler başarıyla listelendi.";
